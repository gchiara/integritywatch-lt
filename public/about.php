      ...
      <div class="container">
        <div class="panel-group" id="accordion">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h1 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">1. Apie</a>
              </h1>
            </div>
            <div id="collapse1" class="panel-collapse collapse in">
              <div class="panel-body">
                ...
                <p>Puslapio dizainą kūrė ir įgyvendino:<br />
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h1 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">2. Parlamentarų susitikimai</a>
              </h1>
            </div>
            <div id="collapse2" class="panel-collapse collapse in">
              <div class="panel-body">
                ...
                <p>Kadangi darbotvarkėse Seimo nariai ne visuomet aiškiai nurodo susitikimo tikslą, TILS darė prielaidą, kad <u>susitikimai su interesų grupėmis</u> yra susitikimai su verslininkais, verslo įmonėmis, religinių bendruomenių atstovais, nevyriausybinėmis ir profesinėmis organizacijomis, asociacijomis (įskaitant paramos ir labdaros fondus), akademikais ir pan.</p>
                <p>Į susitikimų su interesų grupėmis sąrašą nebuvo įtraukti tokie susitikimai, kaip, pavyzdžiui:</p>
                <ul>
                  <li>su valstybės tarnautojais, diplomatais, užsienio delegacijų svečiais bei kitais politikais;</li>
                  <li>su rinkėjais arba kai politikai dalyvauja renginiuose, parodų atidarymuose, knygų pristatymuose, konferencijose ir pan.;</li>
                  <li>pernelyg plačiai ir abstrakčiai įvardinti susitikimai, kai, pavyzdžiui, nurodomas tik asmens vardas arba tik sritis, kurioje veikia interesų grupė („susitikimas su antstoliais, sportininkais“ ir pan.);</li>
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h1 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">3. Ilgalaikiai leidimai į Seimą</a>
              </h1>
            </div>
